...
async def spreadsheets_create(wrapper_services: Aiogoogle) -> str:
    ...
    service = get_google_sheet_service(wrapper_services)
    spreadsheet_body = {
        'properties': {
...
async def set_user_permissions(
    ...
    service = get_google_drive_service(wrapper_services)
...
async def spreadsheets_update_value(
    ...
    for charity_project in charity_projects:
        new_charity_project = [
            ...
            str(charity_project['fundraising_in_days']),
            str(charity_project['fundraising_in_time']),
